package net.dustrean.api.clients.minestom.lobby.events

import net.dustrean.api.clients.item.enums.Material
import net.minestom.server.item.Material as MinestomMaterial
import net.dustrean.api.clients.minestom.events.listenEvent
import net.dustrean.api.clients.minestom.getWorld
import net.dustrean.api.clients.minestom.item.ItemConstants.minestom
import net.dustrean.api.clients.minestom.item.ItemConstants.setItemStack
import net.dustrean.api.clients.minestom.lobby.register.ItemRegister
